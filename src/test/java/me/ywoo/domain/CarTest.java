...
class CarTest {
    ...
    @DisplayName("compareTwoPosition()_숫자 빼서 반환")
    @Test
    public void return_ThisMinusAnother(){
        final Car testCar1 = new Car("test1", 2);
        final Car testCar2 = new Car("test2", 4);
        int actual = testCar1.compareTwoPositions(testCar2);
        int expected = 2;
    ...
    public void return_True_SamePosition(){
        final Car testCar1 = new Car("test1", 4);
        final Car testCar2 = new Car("test2", 4);
        boolean actual = testCar1.isWinnerToo(testCar2);
